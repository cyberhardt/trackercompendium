...
&
for %v in ("C:\torrents\*.torrent") do "C:\Program Files\Transmission\transmission-edit" -a http://nyaa.tracker.wf:7777/announce "%v"
&
for %v in ("C:\torrents\*.torrent") do "C:\Program Files\Transmission\transmission-edit" -a http://sukebei.tracker.wf:8888/announce "%v"
&
for %v in ("C:\torrents\*.torrent") do "C:\Program Files\Transmission\transmission-edit" -a udp://tracker.bitsearch.to:1337/announce "%v"
&
for %v in ("C:\torrents\*.torrent") do "C:\Program Files\Transmission\transmission-edit" -a udp://open.demonii.com:1337 "%v"
&
for %v in ("C:\torrents\*.torrent") do "C:\Program Files\Transmission\transmission-edit" -a udp://open.tracker.cl:1337/announce "%v"
&
for %v in ("C:\torrents\*.torrent") do "C:\Program Files\Transmission\transmission-edit" -a udp://bt1.archive.org:6969/announce "%v"
&
for %v in ("C:\torrents\*.torrent") do "C:\Program Files\Transmission\transmission-edit" -a udp://bt2.archive.org:6969/announce "%v"
&
for %v in ("C:\torrents\*.torrent") do "C:\Program Files\Transmission\transmission-edit" -a https://tracker.bt4g.com:443/announce "%v"
